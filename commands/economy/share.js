...
$onlyIf[$mentioned[1]!=;**⛔ Mention someone to give money to and then the amount, try using this format**: \`$getServerVar[prefix]share <@user> <amount>\`]
...
$suppressErrors[Usage: **$getServerVar[prefix]share <@user> <amount>**]`
}